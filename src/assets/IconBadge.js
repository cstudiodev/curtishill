  ...
  return (
    <svg width="48px" height="48px" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg" stroke-width="3" stroke="#000000" fill="none">
      ...
      <g id="SVGRepo_iconCarrier">
        ...
        <path
          d="M32.74,16.89l2.7,5.49a.1.10,0,0,0,.08.05l6,.88c.08,0,.12.12.06.17l-4.38,4.27a.09.09,0,0,0,0,.09l1,6a.1.10,0,0,1-.14.11l-5.42-2.85a.07.07,0,0,0-.09,0L27.19,34a.11.10,0,0,1-.15-.11l1-6a.1.10,0,0,0,0-.09l-4.39-4.27a.11.10,0,0,1,.06-.17l6.05-.88a.09.09,0,0,0,.08-.05l2.71-5.49A.1.10,0,0,1,32.74,16.89Z"
